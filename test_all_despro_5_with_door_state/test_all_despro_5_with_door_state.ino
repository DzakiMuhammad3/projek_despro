...
void loop() {
  ...
  check_door_state();
  if(IS_OPEN == 1){
    Serial.println("PintuTerbuka");
    write_lcd("Pintu Terbuka", "Mohon ditutup");
    return;
  }
...
//    total_dum = dum1 + dum2 + dum3;
  total_dum = dum1 + dum2;
//     Serial.println(String(dum1) + String(dum2) + String(dum3));
   Serial.println(String(dum1) + String(dum2));
   Serial.println(total_dum);
//  while(total_dum != 2 || total_dum != 0){
//    dum1 = digitalRead(DOOR_SENSOR); 
//    delay(50);
//    dum2 = digitalRead(DOOR_SENSOR);
//    delay(50);
...
//  }
  ...
  Serial.println("Serial Open: " + String(IS_OPEN));
